...
urlpatterns = [
    ...
    path('payments/unpaid-reminders/', views.unpaid_reminders_console_view, name='unpaid_reminders'),
    path('payments/unpaid-reminders/send-bulk/', views.unpaid_reminders_send_bulk_view, name='unpaid_reminders_send_bulk'),
